...
const (
	AuthService_GetAccessTokenFromRefreshToken_FullMethodName = "/auth.AuthService/GetAccessTokenFromRefreshToken"
...
type AuthServiceClient interface {
	GetAccessTokenFromRefreshToken(ctx context.Context, in *GetAccessTokenFromRefreshTokenRequest, opts ...grpc.CallOption) (*GetAccessTokenFromRefreshTokenResponse, error)
...
func (c *authServiceClient) GetAccessTokenFromRefreshToken(ctx context.Context, in *GetAccessTokenFromRefreshTokenRequest, opts ...grpc.CallOption) (*GetAccessTokenFromRefreshTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAccessTokenFromRefreshTokenResponse)
	err := c.cc.Invoke(ctx, AuthService_GetAccessTokenFromRefreshToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	GetAccessTokenFromRefreshToken(context.Context, *GetAccessTokenFromRefreshTokenRequest) (*GetAccessTokenFromRefreshTokenResponse, error)
...
func (UnimplementedAuthServiceServer) GetAccessTokenFromRefreshToken(context.Context, *GetAccessTokenFromRefreshTokenRequest) (*GetAccessTokenFromRefreshTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAccessTokenFromRefreshToken not implemented")
}
...
func (UnimplementedAuthServiceServer) VerifyPasswordReset(context.Context, *VerifyPasswordResetRequest) (*VerifyPasswordResetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyPasswordReset not implemented")
}
...
func _AuthService_GetAccessTokenFromRefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAccessTokenFromRefreshTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetAccessTokenFromRefreshToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetAccessTokenFromRefreshToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAccessTokenFromRefreshToken(ctx, req.(*GetAccessTokenFromRefreshTokenRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AuthService_GetAccessTokenFromRefreshToken_Handler,
		},
		{
			MethodName: "Login",
